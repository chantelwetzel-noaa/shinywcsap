...
abund[3,]  = c(4, "Species abundance is above the target ($1.5*SO_{\\text{PROXY}} \\ge SO > 1.1*SO_{\\text{PROXY}}$) or abundance is unknown and vulnerability is low (1.8 $>$ PSA).")
abund[4,]  = c(5, "Species abundance is below the target ($0.9*SO_{\\text{PROXY}} \\ge SO > \\text{MSST}$) and is not declining.")
abund[5,]  = c(6, "Species abundance is near the target ($1.1*SO_{\\text{PROXY}} \\ge SO > 0.9*SO_{\\text{PROXY}}$), or is unknown and vulnerability is intermediate (2 $>$ PSA $\\ge$ 1.8).")
abund[6,]  = c(7, "Species abundance is below the target ($0.9*SO_{\\text{PROXY}} \\ge SO > \\text{MSST}$) and is declining or recent trend unknown.")
abund[7,]  = c(8, "Species is overfished ($SO \\le \\text{MSST}$) and increasing.")
abund[8,]  = c(9, "Species is overfished ($SO \\le \\text{MSST}$) and stable.")
abund[9,]  = c(9, "Species abundance is unknown and the vulnerability is high (PSA $>$ 2).")
